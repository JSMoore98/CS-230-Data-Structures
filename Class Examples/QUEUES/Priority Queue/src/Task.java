/**
 * Creates an object containing a thing for a ToDo list along with the priority
 */
...
public class Task implements Comparable<Task> {
	...
	//Overrides compareTo method to fit the specific program better
	...
	public String toString() {
		...
		String str = "";
		str = this.primary + "" + this.secondary + ": " + this.task;
