public class ComplexNumber {
	...
	//Creates a new ComplexNumber object in memory to returns the reference to it
	...
	//Need to create new variables to hold the addition without overwriting the original
